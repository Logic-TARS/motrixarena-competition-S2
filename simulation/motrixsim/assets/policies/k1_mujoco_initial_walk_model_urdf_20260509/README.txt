K1 MuJoCo initial walk package, generated 2026-05-09.

This is the version used in the latest MuJoCo rerun:
...
- model/k1_walk_model_5500_torchscript.pt: exported TorchScript policy used by the MuJoCo policy rerun.
- robot/K1_22dof.urdf + robot/meshes/: robot model used by the MuJoCo rerun script.
- motion/k1_walk_procedural_20s.npz: reference motion used by the teacher replay.
- videos/: MuJoCo rerun outputs for quick visual reference.
